...
public class ObjectMapperFactoryTest {
  ...
  private ActivityStream createActivityStreamMessage() throws ActivityStreamsException {
    ActivityStreamObject activityStreamObject = ActivityStreamObject.builder()
        ...
        .withTag(List.of(
            new HSPActivityStreamObjectTag("type1", ActivityStreamObjectTagId.DEACTIVATE_HSP_FORMAT_VALIDATION,
                "name1"),
            new HSPActivityStreamObjectTag("type2", ActivityStreamObjectTagId.DEACTIVATE_HSP_FORMAT_VALIDATION,
                "name2")))
        .build();
