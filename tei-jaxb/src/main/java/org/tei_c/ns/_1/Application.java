 ...
 *         &lt;choice&gt;
 *           &lt;group ref="{http://www.tei-c.org/ns/1.0}model.ptrLike" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class Application {
    ...
    protected List<java.lang.Object> ptrsAndRevesAndListReves;
    ...
    /**
     * Gets the value of the ptrsAndRevesAndListReves property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the ptrsAndRevesAndListReves property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPtrsAndRevesAndListReves().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<java.lang.Object> getPtrsAndRevesAndListReves() {
        if (ptrsAndRevesAndListReves == null) {
            ptrsAndRevesAndListReves = new ArrayList<java.lang.Object>();
        }
        return this.ptrsAndRevesAndListReves;
    }
