...
public class Bibl {
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "msIdentifier", namespace = "http://www.tei-c.org/ns/1.0", type = MsIdentifier.class, required = false),
        @XmlElementRef(name = "explicit", namespace = "http://www.tei-c.org/ns/1.0", type = Explicit.class, required = false),
        @XmlElementRef(name = "incipit", namespace = "http://www.tei-c.org/ns/1.0", type = Incipit.class, required = false),
        @XmlElementRef(name = "decoNote", namespace = "http://www.tei-c.org/ns/1.0", type = DecoNote.class, required = false),
        @XmlElementRef(name = "listRelation", namespace = "http://www.tei-c.org/ns/1.0", type = ListRelation.class, required = false),
        @XmlElementRef(name = "objectIdentifier", namespace = "http://www.tei-c.org/ns/1.0", type = ObjectIdentifier.class, required = false),
