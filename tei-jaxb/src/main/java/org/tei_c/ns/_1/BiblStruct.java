...
public class BiblStruct {
    ...
    protected List<java.lang.Object> notesAndNoteGrpsAndPtrs;
    ...
    /**
     * Gets the value of the notesAndNoteGrpsAndPtrs property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the notesAndNoteGrpsAndPtrs property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getNotesAndNoteGrpsAndPtrs().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<java.lang.Object> getNotesAndNoteGrpsAndPtrs() {
        if (notesAndNoteGrpsAndPtrs == null) {
            notesAndNoteGrpsAndPtrs = new ArrayList<java.lang.Object>();
        }
        return this.notesAndNoteGrpsAndPtrs;
    }
