...
public class CastItem {
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "role", namespace = "http://www.tei-c.org/ns/1.0", type = Role.class, required = false),
        @XmlElementRef(name = "roleDesc", namespace = "http://www.tei-c.org/ns/1.0", type = RoleDesc.class, required = false),
        @XmlElementRef(name = "actor", namespace = "http://www.tei-c.org/ns/1.0", type = Actor.class, required = false),
