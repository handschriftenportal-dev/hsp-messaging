 ...
 *       &lt;choice&gt;
 *         &lt;group ref="{http://www.tei-c.org/ns/1.0}model.correspDescPart" maxOccurs="unbounded"/&gt;
...
@XmlType(name = "", propOrder = {
    "psAndAbs",
    "notesAndNoteGrpsAndCorrespActions"
})
...
public class CorrespDesc {
    ...
    protected List<java.lang.Object> notesAndNoteGrpsAndCorrespActions;
    ...
    /**
     * Gets the value of the notesAndNoteGrpsAndCorrespActions property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the notesAndNoteGrpsAndCorrespActions property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getNotesAndNoteGrpsAndCorrespActions().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<java.lang.Object> getNotesAndNoteGrpsAndCorrespActions() {
        if (notesAndNoteGrpsAndCorrespActions == null) {
            notesAndNoteGrpsAndCorrespActions = new ArrayList<java.lang.Object>();
        }
        return this.notesAndNoteGrpsAndCorrespActions;
    }
