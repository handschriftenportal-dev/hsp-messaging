 ...
 *         &lt;group ref="{http://www.tei-c.org/ns/1.0}model.entryPart"/&gt;
 *         &lt;group ref="{http://www.tei-c.org/ns/1.0}model.morphLike"/&gt;
 ...
 *       &lt;/choice&gt;
 *       &lt;attGroup ref="{http://www.tei-c.org/ns/1.0}att.entryLike.attributes"/&gt;
...
@XmlRootElement(name = "entryFree")
public class EntryFree {

    @XmlElementRefs({
        @XmlElementRef(name = "g", namespace = "http://www.tei-c.org/ns/1.0", type = G.class, required = false),
        @XmlElementRef(name = "superEntry", namespace = "http://www.tei-c.org/ns/1.0", type = SuperEntry.class, required = false),
        @XmlElementRef(name = "hom", namespace = "http://www.tei-c.org/ns/1.0", type = Hom.class, required = false),
        @XmlElementRef(name = "sense", namespace = "http://www.tei-c.org/ns/1.0", type = Sense.class, required = false),
        @XmlElementRef(name = "form", namespace = "http://www.tei-c.org/ns/1.0", type = Form.class, required = false),
        @XmlElementRef(name = "orth", namespace = "http://www.tei-c.org/ns/1.0", type = Orth.class, required = false),
        @XmlElementRef(name = "pron", namespace = "http://www.tei-c.org/ns/1.0", type = Pron.class, required = false),
        @XmlElementRef(name = "hyph", namespace = "http://www.tei-c.org/ns/1.0", type = Hyph.class, required = false),
        @XmlElementRef(name = "syll", namespace = "http://www.tei-c.org/ns/1.0", type = Syll.class, required = false),
        @XmlElementRef(name = "gramGrp", namespace = "http://www.tei-c.org/ns/1.0", type = GramGrp.class, required = false),
        @XmlElementRef(name = "pos", namespace = "http://www.tei-c.org/ns/1.0", type = Pos.class, required = false),
        @XmlElementRef(name = "subc", namespace = "http://www.tei-c.org/ns/1.0", type = Subc.class, required = false),
        @XmlElementRef(name = "colloc", namespace = "http://www.tei-c.org/ns/1.0", type = Colloc.class, required = false),
        @XmlElementRef(name = "def", namespace = "http://www.tei-c.org/ns/1.0", type = Def.class, required = false),
        @XmlElementRef(name = "etym", namespace = "http://www.tei-c.org/ns/1.0", type = Etym.class, required = false),
        @XmlElementRef(name = "usg", namespace = "http://www.tei-c.org/ns/1.0", type = Usg.class, required = false),
        @XmlElementRef(name = "lbl", namespace = "http://www.tei-c.org/ns/1.0", type = Lbl.class, required = false),
        @XmlElementRef(name = "xr", namespace = "http://www.tei-c.org/ns/1.0", type = Xr.class, required = false),
        @XmlElementRef(name = "re", namespace = "http://www.tei-c.org/ns/1.0", type = Re.class, required = false),
        @XmlElementRef(name = "gram", namespace = "http://www.tei-c.org/ns/1.0", type = Gram.class, required = false),
        @XmlElementRef(name = "gen", namespace = "http://www.tei-c.org/ns/1.0", type = Gen.class, required = false),
        @XmlElementRef(name = "number", namespace = "http://www.tei-c.org/ns/1.0", type = Number.class, required = false),
        @XmlElementRef(name = "case", namespace = "http://www.tei-c.org/ns/1.0", type = Case.class, required = false),
        @XmlElementRef(name = "per", namespace = "http://www.tei-c.org/ns/1.0", type = Per.class, required = false),
        @XmlElementRef(name = "tns", namespace = "http://www.tei-c.org/ns/1.0", type = Tns.class, required = false),
        @XmlElementRef(name = "mood", namespace = "http://www.tei-c.org/ns/1.0", type = Mood.class, required = false),
        @XmlElementRef(name = "iType", namespace = "http://www.tei-c.org/ns/1.0", type = IType.class, required = false),
    ...
    protected java.util.List<java.lang.String> targetDatcats;
     ...
     * 
     */
    public java.util.List<java.lang.String> getTargetDatcats() {
