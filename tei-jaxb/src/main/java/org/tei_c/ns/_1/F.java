 ...
 *       &lt;group ref="{http://www.tei-c.org/ns/1.0}model.featureVal" minOccurs="0"/&gt;
...
public class F {
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "vColl", namespace = "http://www.tei-c.org/ns/1.0", type = VColl.class, required = false),
        @XmlElementRef(name = "vNot", namespace = "http://www.tei-c.org/ns/1.0", type = VNot.class, required = false),
        @XmlElementRef(name = "vMerge", namespace = "http://www.tei-c.org/ns/1.0", type = VMerge.class, required = false),
        @XmlElementRef(name = "binary", namespace = "http://www.tei-c.org/ns/1.0", type = Binary.class, required = false),
        @XmlElementRef(name = "symbol", namespace = "http://www.tei-c.org/ns/1.0", type = Symbol.class, required = false),
        @XmlElementRef(name = "numeric", namespace = "http://www.tei-c.org/ns/1.0", type = Numeric.class, required = false),
        @XmlElementRef(name = "string", namespace = "http://www.tei-c.org/ns/1.0", type = org.tei_c.ns._1.String.class, required = false),
        @XmlElementRef(name = "vLabel", namespace = "http://www.tei-c.org/ns/1.0", type = VLabel.class, required = false),
        @XmlElementRef(name = "default", namespace = "http://www.tei-c.org/ns/1.0", type = Default.class, required = false),
        @XmlElementRef(name = "vAlt", namespace = "http://www.tei-c.org/ns/1.0", type = VAlt.class, required = false)
    })
    @XmlMixed
    ...
    @XmlAttribute(name = "fVal")
    protected java.lang.String fVal;
    ...
    /**
     * Ruft den Wert der fVal-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link java.lang.String }
    ...
    /**
     * Legt den Wert der fVal-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link java.lang.String }
     *     
     */
    public void setFVal(java.lang.String value) {
        this.fVal = value;
    }
