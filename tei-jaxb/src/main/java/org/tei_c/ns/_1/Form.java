 ...
 *         &lt;group ref="{http://www.tei-c.org/ns/1.0}model.formPart"/&gt;
...
public class Form {
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "stress", namespace = "http://www.tei-c.org/ns/1.0", type = Stress.class, required = false),
