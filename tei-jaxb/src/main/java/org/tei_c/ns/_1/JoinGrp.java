 ...
 *       &lt;attGroup ref="{http://www.tei-c.org/ns/1.0}att.pointing.group.attributes"/&gt;
...
@XmlType(name = "", propOrder = {
    "equivsAndGlossesAndDescs",
    "joinsAndPtrs"
})
@XmlRootElement(name = "joinGrp")
public class JoinGrp {
    ...
    protected List<java.lang.Object> equivsAndGlossesAndDescs;
    @XmlElements({
        @XmlElement(name = "join", type = Join.class),
        @XmlElement(name = "ptr", type = Ptr.class)
    })
    protected List<java.lang.Object> joinsAndPtrs;
    ...
    protected List<java.lang.String> targFuncs;
    ...
    protected List<java.lang.String> domains;
    ...
    /**
     * Gets the value of the equivsAndGlossesAndDescs property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the equivsAndGlossesAndDescs property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getEquivsAndGlossesAndDescs().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<java.lang.Object> getEquivsAndGlossesAndDescs() {
        if (equivsAndGlossesAndDescs == null) {
            equivsAndGlossesAndDescs = new ArrayList<java.lang.Object>();
        }
        return this.equivsAndGlossesAndDescs;
    }
     ...
     * 
     */
    public List<java.lang.Object> getJoinsAndPtrs() {
        if (joinsAndPtrs == null) {
            joinsAndPtrs = new ArrayList<java.lang.Object>();
        }
     ...
     * 
     */
    public List<java.lang.String> getTargFuncs() {
        if (targFuncs == null) {
            targFuncs = new ArrayList<java.lang.String>();
        }
    ...
    public List<java.lang.String> getDomains() {
        if (domains == null) {
            domains = new ArrayList<java.lang.String>();
        }
        return this.domains;
    }
