 ...
 *         &lt;group ref="{http://www.tei-c.org/ns/1.0}model.labelLike" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;choice maxOccurs="unbounded"&gt;
 *           &lt;group ref="{http://www.tei-c.org/ns/1.0}model.annotationLike"/&gt;
 *           &lt;element ref="{http://www.tei-c.org/ns/1.0}listAnnotation"/&gt;
 *         &lt;/choice&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "", propOrder = {
    "heads",
    "descsAndLabels",
    "notesAndAnnotationBlocksAndAnnotations"
})
...
public class ListAnnotation {
    ...
    protected List<java.lang.Object> notesAndAnnotationBlocksAndAnnotations;
    ...
    /**
     * Gets the value of the notesAndAnnotationBlocksAndAnnotations property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the notesAndAnnotationBlocksAndAnnotations property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getNotesAndAnnotationBlocksAndAnnotations().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<java.lang.Object> getNotesAndAnnotationBlocksAndAnnotations() {
        if (notesAndAnnotationBlocksAndAnnotations == null) {
            notesAndAnnotationBlocksAndAnnotations = new ArrayList<java.lang.Object>();
        }
        return this.notesAndAnnotationBlocksAndAnnotations;
    }
