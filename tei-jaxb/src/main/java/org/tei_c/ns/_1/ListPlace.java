...
@XmlType(name = "", propOrder = {
    "heads",
    "descs",
    "relationsAndListRelationsAndPlaces"
})
...
public class ListPlace {
    ...
    protected List<java.lang.Object> relationsAndListRelationsAndPlaces;
    ...
    /**
     * Gets the value of the relationsAndListRelationsAndPlaces property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the relationsAndListRelationsAndPlaces property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRelationsAndListRelationsAndPlaces().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<java.lang.Object> getRelationsAndListRelationsAndPlaces() {
        if (relationsAndListRelationsAndPlaces == null) {
            relationsAndListRelationsAndPlaces = new ArrayList<java.lang.Object>();
        }
        return this.relationsAndListRelationsAndPlaces;
    }
