 ...
 *             &lt;element ref="{http://www.tei-c.org/ns/1.0}msPart"/&gt;
 *             &lt;element ref="{http://www.tei-c.org/ns/1.0}msFrag"/&gt;
 *           &lt;/choice&gt;
 *         &lt;/choice&gt;
 *       &lt;/sequence&gt;
...
public class MsDesc {
    ...
    @XmlElements({
        ...
        @XmlElement(name = "msPart", type = MsPart.class),
        @XmlElement(name = "msFrag", type = MsFrag.class)
    })
