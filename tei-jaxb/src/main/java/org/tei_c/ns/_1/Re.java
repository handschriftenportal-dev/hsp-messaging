 ...
 *         &lt;element ref="{http://www.tei-c.org/ns/1.0}sense"/&gt;
 *         &lt;group ref="{http://www.tei-c.org/ns/1.0}model.entryPart.top"/&gt;
...
public class Re {
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "entry", namespace = "http://www.tei-c.org/ns/1.0", type = Entry.class, required = false),
        @XmlElementRef(name = "dictScrap", namespace = "http://www.tei-c.org/ns/1.0", type = DictScrap.class, required = false),
