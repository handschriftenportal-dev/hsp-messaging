 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://www.tei-c.org/ns/1.0}rb"/&gt;
 *         &lt;element ref="{http://www.tei-c.org/ns/1.0}rt" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
...
public class Ruby {
    ...
    /**
     * Ruft den Wert der rb-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link Rb }
    ...
    /**
     * Legt den Wert der rb-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link Rb }
     ...
     * This is why there is not a <CODE>set</CODE> method for the rts property.
     * 
     * <p>
