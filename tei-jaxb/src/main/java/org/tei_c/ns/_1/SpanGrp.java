 ...
 *         &lt;element ref="{http://www.tei-c.org/ns/1.0}span" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlRootElement(name = "spanGrp")
public class SpanGrp {

    @XmlElement(name = "desc")
    protected List<Desc> descs;
    @XmlElement(name = "span")
    protected List<Span> spen;
    ...
    /**
     * Gets the value of the spen property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the spen property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * 
     */
    public List<Span> getSpen() {
        if (spen == null) {
            spen = new ArrayList<Span>();
        }
        return this.spen;
    }
