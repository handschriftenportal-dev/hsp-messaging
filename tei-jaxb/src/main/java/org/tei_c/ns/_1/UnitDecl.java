...
@XmlRootElement(name = "unitDecl")
public class UnitDecl {

    @XmlElement(name = "unitDef", required = true)
    protected List<UnitDef> unitDeves;
     ...
     * This is why there is not a <CODE>set</CODE> method for the unitDeves property.
     * 
     * <p>
    ...
    public List<UnitDef> getUnitDeves() {
        if (unitDeves == null) {
            unitDeves = new ArrayList<UnitDef>();
        }
        return this.unitDeves;
    }
